...
<section class="home-hero">
  <div class="bg-glow hero-glow"></div>
  <div class="hero-container container">
    <div class="hero-content">
      <h1><span class="gradient-text">Accounting Services</span> in Irvine, CA</h1>
    ...
    <div class="hero-visual">
      <div class="image-placeholder image-placeholder-large shimmer">
...
<section class="pain-points section-light">
  <div class="container">
    <h2 class="section-title">Are Disorganized Finances <span class="gradient-text">Holding You Back?</span></h2>
    <div class="two-col-layout">
      <div class="content-block">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path>
          <line x1="12" y1="9" x2="12" y2="13"></line>
          <line x1="12" y1="17" x2="12.01" y2="17"></line>
        </svg>
        <h3>The Cost of Chaos & Missed Deadlines</h3>
        <p>Running a business is complex enough without the looming threat of IRS notices, payroll confusion, and late tax filings. When books are disorganized, deadlines are easily missed, resulting in costly penalties and unnecessary stress that drains your focus away from your core business operations.</p>
      </div>
      <div class="content-block">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div class="container">
    ...
    <div class="process-grid">
      <div class="process-step">
        ...
        <h3>Consultation</h3>
        <p>We discuss your specific pain points, goals, and current financial landscape to understand your unique needs.</p>
      </div>
      <div class="process-step">
        <div class="step-number">2</div>
        <h3>Record Review</h3>
        <p>A thorough diagnostic of your existing books, previous tax returns, and overall business financial health.</p>
      </div>
      <div class="process-step">
        <div class="step-number">3</div>
        <h3>Custom Plan</h3>
        <p>We develop a tailored accounting or tax strategy designed specifically to resolve issues and optimize your finances.</p>
      </div>
      <div class="process-step">
        <div class="step-number">4</div>
        <h3>Ongoing Support</h3>
        <p>Continuous bookkeeping, timely tax filing, and strategic advisor support to keep you compliant and growing.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="two-col-layout">
      <div class="trust-visual">
         <div class="image-placeholder image-placeholder-tall shimmer">
          <span>[ Image Placeholder: Professional Tax Prep / Accounting Visual ]</span>
        </div>
      </div>
      <div class="trust-text">
        <h2 class="section-title">Committed to <span class="gradient-text">Accuracy & Compliance</span></h2>
        <p>In the financial world, authority is built on accuracy, and trust is earned through proactive communication. We prioritize meticulous business record keeping and strict adherence to both federal IRS codes and complex California state tax requirements.</p>
        <ul class="trust-list">
          <li>
            <svg class="icon-sm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            <span><strong>Meticulous Organization:</strong> We transform financial chaos into clear, actionable data.</span>
          </li>
          <li>
            <svg class="icon-sm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            <span><strong>Proactive Communication:</strong> You will never have to guess the status of your accounts or filings.</span>
          </li>
          <li>
            <svg class="icon-sm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            <span><strong>Strict Deadline Management:</strong> We track and manage every compliance date so you don't have to.</span>
          </li>
          <li>
            <svg class="icon-sm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            <span><strong>Authoritative Representation:</strong> Experienced guidance through complex tax situations and IRS inquiries.</span>
          </li>
        </ul>
      </div>
    </div>
...
<section class="team-section section-light">
  <div class="container">
