...
<section class="services-overview">
  <div class="container">
    ...
    <div class="services-grid">
      <a href="/services/accountant-irvine-ca/" class="service-card large-card">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <a href="/services/tax-preparation-irvine-ca/" class="service-card large-card">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <a href="/services/bookkeeping-irvine-ca/" class="service-card large-card">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <a href="/services/small-business-accountant-irvine-ca/" class="service-card large-card">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <a href="/services/payroll-services-irvine-ca/" class="service-card large-card">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <a href="/services/business-tax-filing-irvine-ca/" class="service-card large-card">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect>
      ...
      <a href="/services/irs-tax-resolution-irvine-ca/" class="service-card large-card">
        <svg class="icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div class="container">
    <div class="two-col-layout">
      ...
      <div class="trust-text">
        ...
        <ul class="trust-list">
          <li>
            <svg class="icon-sm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f19e3b" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
